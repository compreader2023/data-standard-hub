        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-semibold text-base">产品主数据标准服务平台</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-base">友情链接</h4>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-base">联系我们</h4>
            <ul className="space-y-2 text-base text-primary-foreground/70">
            ...
            <div className="mt-4 relative inline-block">
              <button
                ...
                className="flex items-center gap-2 text-base text-primary-foreground/70 hover:text-secondary transition-colors"
              >
              ...
              {showQr && (
                <div className="absolute bottom-full left-0 mb-2 p-2 bg-background rounded-lg shadow-lg z-50">
                  ...
                  <p className="text-sm text-foreground text-center mt-1">扫码关注CPMS公众号</p>
                </div>
              )}
            </div>
          </div>
        </div>
        <div className="border-t border-sidebar-border mt-8 pt-6 text-center text-sm text-primary-foreground/50">
