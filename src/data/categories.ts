                ...
                children: [
                  {
                    ...
                    description: "",
                    children: [
                      { code: "0.1.1.1.1.010", level: 6, name: "冬小麦", description: "", version: "V1.0", applicationExample: "https://example.com/winter-wheat", expertGroup: "谷物标准专家组", attributes: sampleAttributes },
                      { code: "0.1.1.1.1.011", level: 6, name: "白色硬质冬小麦", description: "种皮为白色或黄色的麦粒不低于90%，角质率不低于70%的冬小麦", version: "V1.1", applicationExample: "https://example.com/white-hard-winter-wheat", expertGroup: "谷物标准专家组", attributes: sampleAttributes },
                      { code: "0.1.1.1.1.012", level: 6, name: "白色软质冬小麦", description: "种皮为白色或黄色的麦粒不低于90%，粉质率不低于70%的冬小麦", version: "V1.0", applicationExample: "", expertGroup: "谷物标准专家组", attributes: sampleAttributes },
                      { code: "0.1.1.1.1.013", level: 6, name: "红色硬质冬小麦", description: "种皮为深红色或红褐色的麦粒不低于90%，角质率不低于70%的冬小麦", version: "V2.0", applicationExample: "", expertGroup: "谷物标准专家组", attributes: sampleAttributes },
                      { code: "0.1.1.1.1.014", level: 6, name: "红色软质冬小麦", description: "种皮为深红色或红褐色的麦粒不低于90%，粉质率不低于70%的冬小麦", version: "V1.0", applicationExample: "", expertGroup: "谷物标准专家组", attributes: sampleAttributes },
                      { code: "0.1.1.1.1.100", level: 6, name: "春小麦", description: "", version: "V1.0", applicationExample: "", expertGroup: "谷物标准专家组", attributes: sampleAttributes },
                      { code: "0.1.1.1.1.101", level: 6, name: "白色硬质春小麦", description: "种皮为白色或黄色的麦粒不低于90%，角质率不低于70%的春小麦", version: "V1.0", applicationExample: "", expertGroup: "谷物标准专家组", attributes: sampleAttributes },
                    ],
                  },
                  {
                    code: "0.1.1.1.2",
